...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: "Demo: State Management with the ValueNotifier",
      initialRoute: "/",
      routes: {
        "/": (context) {
...
Future<void> initApp() async {
  ...
  // Register the user model service and its state with GetIt
  getIt.registerSingleton<UserModelServiceState>(userModelService.serviceState);
